        ...
        <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <div ref={menuref} className='relative'>
                    ...
                    transition-colors duration-300 border border-transparenthover:border-purple-200 '>
                        <div className='relative'>
                            {user.avatar ? (
                                <img src={user.avatar} alt="Avatar" className='w-9 h-9 rounded-fullshadow-sm'/>
                            ):(
                        ...
                        <div className='text-left hidden md:block'>
                            ...
                            <p className='text-xs textgray-500 font-normal'>{user.email}</p>
                        </div>
                    ...
                    {menuOpen && (
                        <ul className='absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn'>
                            <li className='p-2'>
                                ...
                                className='w-full px-4 py-2.5 text-left hover:bg-pruple-50 text-sm text-gray-700 transition-colors flex items-center gap-2 group'
                                role='menuitem'>
